...
namespace Full_GRASP_And_SOLID
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("No se permite agregar Steps nulos");
            }
            ...
            {
                Console.WriteLine("No se permite eliminar Steps nulos");
            }
            
            try
            {
                recipe.RemoveStep(new Step(GetProduct("Leche"), 200, GetEquipment("Hervidor"), 60));
            }
            catch(NotContainStepException ex)
            {
